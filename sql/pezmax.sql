/*
 ...
 Source Schema         : ptmj-platform

 Target Server Type    : MySQL
 Target Server Version : 80044 (8.0.44)
 File Encoding         : 65001

 Date: 22/05/2026 18:58:46
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_bookmark
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_bookmark`;
CREATE TABLE `ptmj_bookmark`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '所属用户ID',
  `url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '目标链接完整URL',
  `title` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '网页标题',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '网页摘要/描述',
  `cover_image` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '网页封面图/Favicon URL',
  `subject` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '关联科目或分类',
  `resource_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'other' COMMENT '资源类型：course/blog/paper/tool/entertainment/other',
  `collection` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属专栏/系列名称',
  `status` tinyint NULL DEFAULT 0 COMMENT '书签状态：0-未审核，1-通过，2-未通过，3-被举报',
  ...
  `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '用户自定义备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_bookmark_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_bookmark_subject`(`subject` ASC) USING BTREE,
  INDEX `idx_bookmark_resource_type`(`resource_type` ASC) USING BTREE,
  INDEX `idx_bookmark_collection`(`collection` ASC) USING BTREE,
  INDEX `idx_bookmark_status`(`status` ASC) USING BTREE,
  INDEX `idx_bookmark_del_flag`(`del_flag` ASC) USING BTREE,
  INDEX `idx_bookmark_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '外部书签表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_bookmark_favorite
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_bookmark_favorite`;
CREATE TABLE `ptmj_bookmark_favorite`  (
...
-- ----------------------------
-- Table structure for ptmj_bookmark_report
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_bookmark_report`;
CREATE TABLE `ptmj_bookmark_report`  (
  `report_id` bigint NOT NULL AUTO_INCREMENT COMMENT '举报ID',
  `bookmark_id` bigint NOT NULL COMMENT '被举报的书签ID（关联 ptmj_bookmark.id）',
  `user_id` bigint NOT NULL COMMENT '举报用户ID（关联 ptmj_user.user_id）',
  `reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '举报原因（用户填写）',
  `result` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '审核结果：0-未审核，1-属实，2-不属实',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建者（即举报人用户名，冗余字段）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '举报时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '最后操作的管理员用户名',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间（审核时间）',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '处理备注（管理员填写，区别于用户填写的 reason）',
  PRIMARY KEY (`report_id`) USING BTREE,
  UNIQUE INDEX `uk_user_bookmark`(`user_id` ASC, `bookmark_id` ASC) USING BTREE COMMENT '同一用户对同一书签只能举报一次',
  INDEX `idx_bookmark_id`(`bookmark_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_result`(`result` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '书签举报表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_file
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_file`;
CREATE TABLE `ptmj_file`  (
  ...
  `file_format` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文件格式，如：pdf、doc、docx、zip等',
  `file_year` int NULL DEFAULT NULL COMMENT '文件年份，如：2024',
  `file_type` tinyint NULL DEFAULT NULL COMMENT '文件类型：1-期末，2-期中，3-资料，4-补考，5-其他学校',
  `file_subject` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '科目',
  `reviewer` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '审核人',
  `file_status` tinyint NULL DEFAULT 0 COMMENT '文件状态：0-未审核，1-通过，2-未通过，3-被举报',
  `del_flag` tinyint NULL DEFAULT 0 COMMENT '删除标记：0-未删除，1-已删除',
  ...
  INDEX `idx_upload_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_file_year`(`file_year` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '试卷文件表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_file_download
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_file_download`;
CREATE TABLE `ptmj_file_download`  (
  `download_id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `file_id` bigint NOT NULL COMMENT '文件id',
  `user_id` bigint NOT NULL COMMENT '下载的用户id',
  `creat_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建者',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`download_id`, `file_id`, `user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '试卷下载表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_file_favorite
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_file_favorite`;
CREATE TABLE `ptmj_file_favorite`  (
  `file_id` bigint NOT NULL COMMENT '文件id',
  `user_id` bigint NOT NULL COMMENT '收藏的用户id',
  PRIMARY KEY (`file_id`, `user_id`) USING BTREE,
  INDEX `dld_usr_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '试卷收藏表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_notification
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_notification`;
CREATE TABLE `ptmj_notification`  (
  `notify_id` bigint NOT NULL AUTO_INCREMENT COMMENT '通知主键',
  `notify_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '通知类型（1版本更新 2系统故障 3系统维护 4资料下架 5日常滚动）',
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '通知标题',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '通知正文',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '配置状态（0启用 1禁用）',
  `sort` int NOT NULL DEFAULT 0 COMMENT '排序/优先级（越大越优先弹出）',
  `display_mode` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '展示形态（0弹窗 1滚动字幕）',
  `fault_start_time` datetime NULL DEFAULT NULL COMMENT '故障开始时间（仅类型2）',
  `fault_end_time` datetime NULL DEFAULT NULL COMMENT '故障结束时间（可为空，一直到管理员手动关；仅类型2）',
  `maintenance_start_time` datetime NULL DEFAULT NULL COMMENT '维护开始时间（仅类型3）',
  `maintenance_end_time` datetime NULL DEFAULT NULL COMMENT '维护结束时间（可为空，一直到管理员手动关；仅类型3）',
  `remind_before_minutes` int NULL DEFAULT NULL COMMENT '维护提前提醒分钟数（仅类型3）',
  `upload_user_id` bigint NULL DEFAULT NULL COMMENT '接收被举报下架通知用户的id（即上传表上传用户 id；仅类型4）',
  `material_id` bigint NULL DEFAULT NULL COMMENT '被举报下架的资料的id（关联资料表id；仅类型4）',
  `material_title_snapshot` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '保存下架资料的标题，防止原资料删除后无法展示（仅类型4）',
  `publish_start` datetime NULL DEFAULT NULL COMMENT '滚动日常通知展示开始时间，可为空即立即开始（仅类型5）',
  `publish_end` datetime NULL DEFAULT NULL COMMENT '滚动日常通知展示结束时间，可为空，一直到管理员手动关（仅类型5）',
  `scroll_time_interval` int NULL DEFAULT 30 COMMENT '滚动时间间隔（仅类型5）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  UNIQUE INDEX `uk_material_notify`(`material_id` ASC) USING BTREE COMMENT '避免同一份资料重复两条下架通知。',
  INDEX `idx_notify_type_status`(`notify_type` ASC, `status` ASC) USING BTREE COMMENT '按 类型 和 是否启用 一起查时用的组合索引',
  INDEX `idx_target-user`(`upload_user_id` ASC) USING BTREE COMMENT '用户多了以后查询不会每次都扫全表。加速 WHERE target_user_id = ? 查询',
  INDEX `idx_publish`(`publish_start` ASC, `publish_end` ASC) USING BTREE COMMENT '按 publish_start、publish_end 做范围查询。\r\n按 publish_start、publish_end 做范围查询。\r\n按 publish_start、publish_end 做范围查询。'
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '通知表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_report
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_report`;
CREATE TABLE `ptmj_report`  (
  `report_id` bigint NOT NULL AUTO_INCREMENT COMMENT '举报id',
  `file_id` bigint NOT NULL COMMENT '被举报文件id',
  `user_id` bigint NOT NULL COMMENT '举报用户id',
  `reason` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '被举报原因',
  `result` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '审核结果（0未审核 1属实 2不属实）',
  ...
  PRIMARY KEY (`report_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '举报表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_security
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_security`;
CREATE TABLE `ptmj_security`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `question` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '密保问题',
  `answer` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '密保答案',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户密保表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ptmj_user
-- ----------------------------
DROP TABLE IF EXISTS `ptmj_user`;
CREATE TABLE `ptmj_user`  (
  `user_id` bigint NOT NULL AUTO_INCREMENT COMMENT '用户id（不对外显示）',
  ...
  `count` int NULL DEFAULT 0 COMMENT '上传文件数量',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1' COMMENT '账号状态（0为封禁，1为正常）',
  `creat_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '注册时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`user_id`) USING BTREE,
  UNIQUE INDEX `user_name`(`user_name` ASC) USING BTREE COMMENT '用户账号'
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '平台用户表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 199 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 272 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
